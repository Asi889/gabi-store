...
export default function ProductsPage() {
  ...
  const [currentFilters, setCurrentFilters] = useState<any>({ categories: [], colors: [], sizes: [], availability: 'all' });
  ...
  return (
    <div className="min-h-screen pt-32 pb-24 bg-[#F7F1EE]">
      ...
      <div className="px-8 mb-8 max-w-[1400px] mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-gray-100 pb-12">
          <div>
            ...
            <div className="flex items-center gap-4 text-[10px] text-slate-600 font-bold uppercase tracking-widest text-gray-400">
            ...
            <div className="relative flex-1 md:w-80">
              <input 
                ...
                onChange={(e) => {
                  ...
                  applyFilters(currentFilters, newSearch);
                }}
      ...
      <div className="max-w-[1400px] mx-auto md:px-8 px-6 bg-[#F7F1EE]">
        ...
        {/* Main Product Grid */}
        <div className="flex-1 bg-[#eae6e2]">
          {filteredProducts.length > 0 ? (
            ...
            <div className="h-[400px] flex flex-col items-center justify-center bg-gray-50 border-2 border-dashed border-gray-100">
              ...
              <button 
                onClick={() => {
                  setSearchQuery("");
                  setCurrentFilters({ categories: [], colors: [], sizes: [], availability: 'all' });
